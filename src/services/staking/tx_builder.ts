...
export async function buildDelegateDraft(
  ...
  const expiryBlocksNum = typeof expiryDurationBlocks === 'bigint' ? Number(expiryDurationBlocks) : expiryDurationBlocks;
  const maxValueNum = typeof maxValuePerOperation === 'bigint' ? Number(maxValuePerOperation) : maxValuePerOperation;
